    		...
    		<table class="table table-striped table-hover table-bordered" style="background-color: white">
	        	...
	        	<tbody>
	        		<tr ng-repeat="book in Books |filter:Search">
                        ...
                        <td class="text-center"><font color="green">Accepted</font></td>
	        			
	        			<td>
	        				<button class="btn btn-primary btn-block" data-toggle="modal" data-target="#BorrowModal{{$index}}" ng-click="CheckAvailability(book.ISBN)">Pay</button>
                            <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#BorrowModal{{$index}}" ng-click="CheckAvailability(book.ISBN)">Cancel</button>
